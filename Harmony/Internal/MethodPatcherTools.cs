    ...
    internal class MethodPatcherTools
    {
        ...
        )
        {
            ...
            for (var i = 0; i < parameters.Length; i++)
            {
                ...
                // Strip HasDefault — DMD wrappers don't need default values, and
                // copying them causes Cecil to resolve the parameter type at write
                // time, which fails for game assembly types. Without this strip,
                // leaving HasDefault without a Constant entry crashes Mono
                // (blob_type_enum=0 → MONO_TYPE_END in GetParameters()).
